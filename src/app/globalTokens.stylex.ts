...
export const globalTokens = stylex.defineVars({
  ...
  backgroundStartRGB: { default: "214, 219, 220", [DARK_MODE]: "0, 0, 0" },
  backgroundEndRGB: { default: "255, 255, 255", [DARK_MODE]: "0, 0, 0" },
  ...
  tileStartRGB: { default: "239, 245, 249", [DARK_MODE]: "2, 13, 46" },
  tileEndRGB: { default: "228, 232, 233", [DARK_MODE]: "2, 5, 19" },
  tileBorder: {
    default: `conic-gradient(
      #00000080,
      #00000040,
  ...
  calloutRGB: { default: "238, 240, 241", [DARK_MODE]: "20, 20, 20" },
  calloutBorderRGB: { default: "172, 175, 176", [DARK_MODE]: "108, 108, 108" },
  cardRGB: { default: "180, 185, 188", [DARK_MODE]: "100, 100, 100" },
  cardBorderRGB: { default: "131, 134, 135", [DARK_MODE]: "200, 200, 200" },
...
/**
    Stylex source :
 * https://github.com/nmn/nextjs-app-dir-stylex/blob/main/app/page.tsx
 */
const MIN_WIDTH = 320;
